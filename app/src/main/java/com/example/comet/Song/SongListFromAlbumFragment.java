...
public class SongListFromAlbumFragment extends Fragment {
    ...
    public static SongListFromAlbumFragment newInstance(ArrayList<MusicModel> songsList) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            songsList = (ArrayList<MusicModel>) getArguments().get(Constants.SONGS_PARAM);
        }
    }
